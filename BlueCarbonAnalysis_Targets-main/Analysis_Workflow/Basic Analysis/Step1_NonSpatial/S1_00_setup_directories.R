...
output_dirs <- c(
  ...
  # Step-structured presentation outputs (mirror Analysis_Workflow folder layout)
  "outputs/Basic_analysis",
  "outputs/Basic_analysis/Step1_NonSpatial",
  "outputs/Basic_analysis/Step1_NonSpatial/Tables",    # S1_01: cleaned data + summaries
  "outputs/Basic_analysis/Step1_NonSpatial/Plots",     # S1_02: EDA plots
  "outputs/Basic_analysis/Step2_Spatial_Basic",
  "outputs/Basic_analysis/Step2_Spatial_Basic/SimpleExtrapolation",  # S2a: tables + maps + plots
  "outputs/Basic_analysis/Step2_Spatial_Basic/Kriging",              # S2b: kriging maps + summaries
  "outputs/Advanced_analysis",
  "outputs/Advanced_analysis/Step3_Spatial_Advanced",
  "outputs/Advanced_analysis/Step3_Spatial_Advanced/RF_Maps",        # S3_01: RF depth maps
  "outputs/Advanced_analysis/Step3_Spatial_Advanced/RF_Diagnostics", # S3_01: diagnostics
  "outputs/Advanced_analysis/Step3_Spatial_Advanced/Carbon_Stock_Totals", # S3_02
  "outputs/Advanced_analysis/Step3_Spatial_Advanced/Reports",        # S3_03: HTML report
  # Legacy quick-access folders (kept for backward compat)
  "outputs/Basic_analysis/Carbon_Stock_Calculations",
  "outputs/Basic_analysis/Spatial_Maps_by_Depth",
  "outputs/Basic_analysis/Exploratory_Data_Plots",
  "outputs/Advanced_spatial_analysis",
  "outputs/Advanced_spatial_analysis/RF_Maps_by_Depth",
  "outputs/Advanced_spatial_analysis/RF_Diagnostics_and_Importance",
  ...
  # Step 4: Transfer Learning (3-model comparison)
  "outputs/Transfer_learning",
  "outputs/Transfer_learning/Model1_GEE",
  "outputs/Transfer_learning/Model1_GEE/tables",
  "outputs/Transfer_learning/Model1_GEE/models",
  "outputs/Transfer_learning/Model1_GEE/maps",
  "outputs/Transfer_learning/Model2_Embeddings",
  "outputs/Transfer_learning/Model2_Embeddings/tables",
  "outputs/Transfer_learning/Model2_Embeddings/models",
  "outputs/Transfer_learning/Model2_Embeddings/maps",
  "outputs/Transfer_learning/Model3_Combined",
  "outputs/Transfer_learning/Model3_Combined/tables",
  "outputs/Transfer_learning/Model3_Combined/models",
  "outputs/Transfer_learning/Model3_Combined/maps",
  "outputs/Transfer_learning/Comparison",
  "outputs/Transfer_learning/Global_vs_Local_Comparisons"
)
