...
# =============================================================================
# INTERNAL HELPERS — batch extraction engine (unchanged from blue carbon version)
# =============================================================================
...
combine_covariates <- function(profiles_df, topo, sar, s2, climate) {
  ...
  # Drop any legacy blue carbon bands that may appear in old data files
  legacy_bands <- c(
    "elevationRelMHW", "tidal_flat_prob", "coastal_dist_m", "dist_to_channel_m",
    "mNDWI_median", "tidal_wetness", "tpi", "EVI_median_old",
